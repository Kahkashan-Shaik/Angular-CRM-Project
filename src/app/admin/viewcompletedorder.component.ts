                                          ...
                                          <div class="table-responsive">
                                              <table datatable [dtOptions]="dtOptions" [dtTrigger]="dtTrigger"  class="table table-bordered table-sm  nowrap  text-center text-sm" >
                                                  ...
                                                  <tbody>
                                                    ...
                                                    <tr *ngFor="let odata of this.completedOrderList; let i=index">
                                                        <td>{{ i+1 }}</td>  
...
export class ViewCompletedOrderComponent extends ImageModalPopUp implements OnInit, OnDestroy{
    ...
    manufac_id:any;
    status_id:any;
    constructor( private srvcobj: AdminServiceService ){super();}
    ngOnInit(): void {
